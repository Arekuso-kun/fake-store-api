...
export const buttonTheme: CustomFlowbiteTheme["button"] = {
  ...
  color: {
    primary:
      "border border-transparent bg-primary-500 text-white focus:ring-4 focus:ring-primary-200 enabled:hover:bg-primary-600 dark:bg-primary-500 dark:focus:ring-primary-800 dark:enabled:hover:bg-primary-500",
  ...
  label:
    "ml-2 inline-flex h-4 w-4 items-center justify-center rounded-full bg-primary-200 text-xs font-semibold text-primary-600",
  outline: {
    color: {
